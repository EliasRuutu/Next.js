  ...
  function SamplePrevArrow(props: any) {
    ...
    return (
      <div>
        ...
        <div onClick={onClick} className="w-12 h-12 rounded-full bg-white text-[32px] leading-8 font-bold flex justify-center items-center absolute -left-5 top-[50%] z-10 cursor-pointer translate-x-[12px] sm:translate-x-[36px]">
