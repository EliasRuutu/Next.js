...
const PlanesComp = () => {
  ...
  function SampleNextArrow(props: any) {
    ...
    return (
      ...
      <div onClick={onClick} className="w-12 h-12 rounded-full bg-wight text-[32px] leading-8 font-bold flex justify-center items-center absolute -right-5 top-[50%] cursor-pointer translate-x-[-36px]">
        <Image width={48} height={48} src={rightArrow} alt="next"/>
      </div>
      </div>
    );
  }
  ...
  function SamplePrevArrow(props: any) {
    ...
    return (
      <div>
        ...
        <div onClick={onClick} className="w-12 h-12 rounded-full bg-white text-[32px] leading-8 font-bold flex justify-center items-center absolute -left-5 top-[50%] z-10 cursor-pointer translate-x-[36px]">
          <Image width={48} height={48} src={leftArrow} alt="prev"/>
        </div>
        </div>
    );
  }
