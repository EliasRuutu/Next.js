...
const PaymentStatus = () => {
    ...
    useEffect(() => {
        ...
        const initializePaymentWidgets = () => {
                    ...
                    if (telefonoInput) {
                        telefonoInput.addEventListener('input', function (e) {
                            ...
                            if (value.length < 12) {
                                ...
                                setTelefonoError('Por favor ingresa un número completo de teléfono (mínimo 11 dígitos).');
                            } else {
                                if (submitButton) {
            ...
            if (window.wpwlOptions && typeof window.wpwlOptions.onReady === 'function') {
        ...
        <>
            <section className="bg-white relative">
                <div className="w-full min-h-screen flex flex-col justify-around items-center gap-5 pt-24 content-center">
                    <form action={`${process.env.NEXT_PUBLIC_APP_URL}/statusPayment?base64=${formulario}`} className="paymentWidgets wpwl-form-card" data-brands="VISA MASTER AMEX"></form>
